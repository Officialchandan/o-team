...
class NewGrcData extends State<AddNewVegGrc>
{
  ...
  getFirstForm()
  {
    return new ListView(
      ...
      [
        ItemNameFeild(),
        Item_name==""?new Container():  InkWell(
  ...
  GetSaveItemBtn()
  {
    return RaisedButton(
      ...
      child: Text(
        'Save', style: GlobalWidget.textbtnstyle(),
      ),
    );
  }
  ...
  ItemNameFeild() {
    return loading ? new Container() : searchTextField = GlobalSearchItem.getAutoSelectionField(key,SearchItems,searchTextField,onSelectItem);
  }
