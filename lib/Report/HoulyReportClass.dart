...
import 'ModelClassReportDetail/DateModel.dart';
...
class ReoportView extends State<HorlyReprtDetailActivity> {
  var products;
  var listdata;
  ...
  static Widget getAllAmount(List<DateModel> dateList, items_column_heading) {
    double amt = 0.0;
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, dateIndex) {
          return ExpansionTile(
            title: Text(DateList[dateIndex].DateString),
            children: [
              new Container(
                height: 60.0,
              ...
              ListView.builder(
                  itemCount: DateList[dateIndex].grp_modelList.length,
                  physics: ClampingScrollPhysics(),
                  shrinkWrap: true,
