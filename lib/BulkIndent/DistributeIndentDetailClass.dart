...
class DistributeActivity extends StatefulWidget {
  var data;

  DistributeActivity(this.data);
...
class ViewData extends State<DistributeActivity> {
...
*/
    ...
    Map<String, dynamic> mapdata() => {
          ...
          'procName': GlobalConstant.Mapp_Whrtv_Itemlist_Blk,
          'rid': '',
                    ...
                    new Row(
                      children: [
                        ...
                        Expanded(
                          ...
                          child: InkWell(
                            onTap: () {
                              dataval.flag_RT = !dataval.flag_RT;

                              getRetrivedNF(dataval);
                              setState(() {});
                            },
                            child: new Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text(widget.data["ItemName"].toString()),
                        new Row(
                          children: [
                            Expanded(
                                flex: 6,
                                child: Text(
                                  "BCode : " + widget.data["Barcode"],
                                  style: TextStyle(fontSize: 10),
                                )),
                            Expanded(
                              flex: 4,
                              child: Text(
                                "Stk : " + widget.data["Stock"],
                                textAlign: TextAlign.right,
                              ),
                            )
                          ],
