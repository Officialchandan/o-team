...
class SearchCityWiseStore extends StatefulWidget {
  static String tag = 'SearchCityWiseStore';
  String City_Id;

  SearchCityWiseStore(this.City_Id);

  @override
  _SearchCityWiseStoreState createState() => new _SearchCityWiseStoreState();
}

class _SearchCityWiseStoreState extends State<SearchCityWiseStore> {
